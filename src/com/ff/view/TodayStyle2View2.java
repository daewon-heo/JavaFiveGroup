...
public class TodayStyle2View2 extends JFrame {
	private static final long serialVersionUID = 781983372302967463L;
	
	private static TodayStyle2View2 instance = null;
	private JButton[] btnArr = null;
	private Image[] picArr = null;
	private String[] pathArr = null;
	
	public static TodayStyle2View2 getInstance() {
		if(instance == null)
			instance = new TodayStyle2View2();
	...
	public void addBtnActionListener() {
		btnArr[0].addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				TodayStyleView2 view1 = TodayStyleView2.getInstance(); 
