...
public class PastWeatherView extends JFrame {
	...
	public void detailView(String pastIcon, String presentIcon, double temperature, String humidity, double ta,
		...
		Image pastWeatherIcon = new ImageIcon(pastIcon).getImage().getScaledInstance(200, 200, 0);

		Image presentWeaterIcon = new ImageIcon(presentIcon).getImage().getScaledInstance(200, 200, 0);
		...
		presentTemperature.setBounds(485, 350, 120, 30);

		presentHumidity.setFont(new Font("맑은 고딕", Font.BOLD, 11));
		presentHumidity.setFont(presentHumidity.getFont().deriveFont(35.0f));
		presentHumidity.setBounds(485, 420, 120, 30);

		iconLb1.setBounds(80, 105, 200, 200);
		iconLb2.setBounds(435, 105, 200, 200);
