...
public class MainController {
	...
	/*public MainController(){
		...
		high = Weather.GetPastWeather("108", cal.getWeekYear(), "08")[cal.get(Calendar.DATE)][cal.get(Calendar.DAY_OF_MONTH)-1];
		low = Weather.GetPastWeather("108", cal.getWeekYear(), "10")[cal.get(Calendar.DATE)][cal.get(Calendar.DAY_OF_MONTH)-1];
